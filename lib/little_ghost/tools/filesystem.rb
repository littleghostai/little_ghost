...
module LittleGhost
  ...
  module Tools
    ...
    class Filesystem
      ...
      class ReadFile < Tool
        tool_name "read_file"
        description FrameworkPrompts.new.render("tools/built_in/read_file/description")
        ...
        def description = framework_prompt("tools/built_in/read_file/description")
      end

      # Lists one directory through the configured sandbox.
      class ListFiles < Tool
        tool_name "list_files"
        description FrameworkPrompts.new.render("tools/built_in/list_files/description")
        ...
        def description = framework_prompt("tools/built_in/list_files/description")
      end

      # Writes one UTF-8 text file through a writable sandbox.
      class WriteFile < Tool
        tool_name "write_file"
        description FrameworkPrompts.new.render("tools/built_in/write_file/description")
        ...
        def description = framework_prompt("tools/built_in/write_file/description")
      end

      # Replaces one unique text occurrence through a writable sandbox.
      class ReplaceInFile < Tool
        tool_name "replace_in_file"
        description FrameworkPrompts.new.render("tools/built_in/replace_in_file/description")
        input_schema type: "object", properties: {
        ...
        def description = framework_prompt("tools/built_in/replace_in_file/description")
      end
